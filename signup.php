...
if(isset($_POST['btn-signup'])) {
        ...
        $query="insert into users(name,email,password) values('$uname','$email','$upass')";       
		if(pg_query($query)){
	?>
...
<body>
    ...
    <div class="login-card"><img src="assets/img/avatar_2x.png" class="profile-img-card">
        ...
        <form class="form-signin" method=post action='home.php'><span class="reauth-email"> </span>
            ...
            <input class="form-control" type="password" required="" name="password" placeholder="Confirm Password" autofocus="" id="inputEmail">
            <div class="checkbox">
                <div class="checkbox">
                    <label>
